...
function openPopup(event) {
    ...
    document.getElementById('viewMode').innerHTML = `<h3 style="margin-top:0">${event.title}</h3><p>${event.start.toLocaleTimeString([], {hour: '2-digit', minute:'2-digit'})} - ${event.end.toLocaleTimeString([], {hour: '2-digit', minute:'2-digit'})}</p>`;
