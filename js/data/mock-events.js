...
export const demoEvents = [
    // --- LUNDI 6 AVRIL ---
    {
        ...
        extendedProps: { owner: 'eleve1@iams.fr', ownerDisplayName: 'Élève 1', type: 'reservation' }
    },
    {
        title: 'Marie (Élève 2)',
        start: '2026-04-06T14:00:00',
        end: '2026-04-06T14:30:00', // 30min -> Affichera TITRE SEUL (centré)
        extendedProps: { owner: 'eleve2@iams.fr', ownerDisplayName: 'Élève 2', type: 'reservation' }
    },
    ...
    // --- MARDI 7 AVRIL ---
    {
        ...
        extendedProps: { owner: 'admin@iams.fr', ownerDisplayName: 'Admin IAMS', type: 'cours' }
    },
    {
        title: 'Prof. Durif',
        start: '2026-04-07T15:00:00',
        end: '2026-04-07T17:00:00',
        extendedProps: { owner: 'prof@iams.fr', ownerDisplayName: 'Prof IAMS', type: 'reservation' }
    },
    ...
    },
    {
        ...
        extendedProps: { owner: 'admin@iams.fr', ownerDisplayName: 'Admin IAMS', type: 'fermeture' }
    },
